...
{
    internal class SeeFailedMetric : Verification<ForecastProviderDependencies, ForecastProvider, GetForecastParameters, Task<WeatherForecast?>>
    {
        public override void Verify()
        {
            Attempt.SutDependencies.ForecastMetricHandlerMock
                .Verify(x => x.IncreaseFailedProvidedForecast(), Times.Once);
        }
    }
}
